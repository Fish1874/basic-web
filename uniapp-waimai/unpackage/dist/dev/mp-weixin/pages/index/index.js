...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var SearchPage = function SearchPage() {Promise.all(/*! require.ensure | components/search/index */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/search/index")]).then((function () {return resolve(__webpack_require__(/*! @/components/search */ 37));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  data: function data() {
    return {
      ...
      icons: [
      { icon: __webpack_require__(/*! @/static/icon/ic_scan.png */ 20), text: '扫一扫' },
      { icon: __webpack_require__(/*! @/static/icon/ic_bulk.png */ 21), text: '附近团购' },
      { icon: __webpack_require__(/*! @/static/icon/ic_take_out.png */ 22), text: '外卖自提' },
      { icon: __webpack_require__(/*! @/static/icon/ic_eat_in.png */ 23), text: '堂食点餐' },
      { icon: __webpack_require__(/*! @/static/icon/ic_buying_agent.png */ 24), text: '跑腿代购' },
      { icon: __webpack_require__(/*! @/static/icon/ic_department.png */ 25), text: '商品百货' },
      { icon: __webpack_require__(/*! @/static/icon/ic_discount.png */ 26), text: '折扣优惠' },
